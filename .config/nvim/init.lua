...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        ['<leader>h'] = { name = '[H] Git', _ = 'which_key_ignore' },
      }
    end,
  },
  ...
  --  This is useful for plugins that rely on other plugins to function.
  --  For example, Telescope requires plenary.nvim to function.
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.api.nvim_set_keymap(
        ...
        { noremap = true, desc = '[S]ile Browser of current [Buffer]' }
      )

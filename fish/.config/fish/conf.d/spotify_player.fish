...
complete -c spotify_player -n "__fish_spotify_player_needs_command" -f -a "features" -d 'Print compiled in features'
...
complete -c spotify_player -n "__fish_spotify_player_using_subcommand playlist; and not __fish_seen_subcommand_from new delete import list fork sync edit help" -s h -l help -d 'Print help'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand playlist; and not __fish_seen_subcommand_from new delete import list fork sync edit help" -f -a "new" -d 'Create a new playlist'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand playlist; and not __fish_seen_subcommand_from new delete import list fork sync edit help" -f -a "delete" -d 'Delete a playlist'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand playlist; and not __fish_seen_subcommand_from new delete import list fork sync edit help" -f -a "import" -d 'Imports all songs from a playlist into another playlist.'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand playlist; and not __fish_seen_subcommand_from new delete import list fork sync edit help" -f -a "list" -d 'Lists all user playlists.'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand playlist; and not __fish_seen_subcommand_from new delete import list fork sync edit help" -f -a "fork" -d 'Creates a copy of a playlist and imports it.'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand playlist; and not __fish_seen_subcommand_from new delete import list fork sync edit help" -f -a "sync" -d 'Syncs imports for all playlists or a single playlist.'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand playlist; and not __fish_seen_subcommand_from new delete import list fork sync edit help" -f -a "edit" -d 'Add or remove tracks or albums from a playlist.'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand playlist; and not __fish_seen_subcommand_from new delete import list fork sync edit help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c spotify_player -n "__fish_spotify_player_using_subcommand playlist; and __fish_seen_subcommand_from edit" -s t -l track-id -d 'Track ID to add or remove' -r
complete -c spotify_player -n "__fish_spotify_player_using_subcommand playlist; and __fish_seen_subcommand_from edit" -s a -l album-id -d 'Album ID to add or remove' -r
complete -c spotify_player -n "__fish_spotify_player_using_subcommand playlist; and __fish_seen_subcommand_from edit" -s h -l help -d 'Print help'
...
complete -c spotify_player -n "__fish_spotify_player_using_subcommand playlist; and __fish_seen_subcommand_from help" -f -a "edit" -d 'Add or remove tracks or albums from a playlist.'
...
complete -c spotify_player -n "__fish_spotify_player_using_subcommand features" -s h -l help -d 'Print help'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features help" -f -a "get" -d 'Get Spotify data'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features help" -f -a "playback" -d 'Interact with the playback'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features help" -f -a "connect" -d 'Connect to a Spotify device'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features help" -f -a "like" -d 'Like currently playing track'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features help" -f -a "authenticate" -d 'Authenticate the application'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features help" -f -a "playlist" -d 'Playlist editing'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features help" -f -a "generate" -d 'Generate shell completion for the application CLI'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features help" -f -a "search" -d 'Search spotify'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features help" -f -a "features" -d 'Print compiled in features'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and __fish_seen_subcommand_from playlist" -f -a "edit" -d 'Add or remove tracks or albums from a playlist.'
